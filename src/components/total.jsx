import { Box, Button, Flex, Heading, Text, Popover, PopoverTrigger, PopoverContent, PopoverHeader, PopoverArrow, PopoverCloseButton, PopoverBody, useColorModeValue } from "@chakra-ui/react";
...
export default function Total(props) {
    ...
    return (
        <Flex className="BungkusTotal" gap='20px' flexDir={{ base: 'column', md: 'row', lg: 'row' }}>
            <Flex className="BungkusTotalExpense" border='4px' borderRadius='13px' borderColor={color} width='auto' height='80px' gap='20px'>
                <Box display='flex' flexDir="column" width='110px' justifyContent='center' marginLeft='20px'>
                    <Text textAlign='left' color={color} fontSize='large'>Expense</Text>
                ...
                <Box display='flex' flexDir="column" justifyContent='center' alignItems='flex-end'>
                    <Popover isLazy>
                        <PopoverTrigger>
                            <Button marginRight='15px' bg={bg} fontSize='xl' color={logo} _hover={{ bg: '#3F4E4F' }}><MdHistory /></Button>
                        </PopoverTrigger>
            ...
            <Flex className="BungkusTotalExpense" border='4px' borderRadius='13px' borderColor={color} width='auto' height='80px' gap='20px'>
                <Box display='flex' flexDir="column" width='110px' justifyContent='center' marginLeft='20px'>
                    <Text textAlign='left' color={color} fontSize='large' >Income </Text>
